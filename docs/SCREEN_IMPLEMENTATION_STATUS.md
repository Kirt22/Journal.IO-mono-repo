...
| Paywall | `/paywall` | `frontend/src/screens/profile/PaywallScreen.tsx` | implemented | Paywall screen now mirrors the Make premium upsell flow more closely with the sticky header, animated mascot hero, selectable monthly/yearly plans, exact feature copy, trust note, restore action, and fixed bottom CTA. | 2026-04-03 |
