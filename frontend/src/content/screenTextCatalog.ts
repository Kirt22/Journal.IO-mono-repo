...
export const screenTextCatalog = {
  ...
  "profile/LifetimeOfferPaywallScreen.tsx": [
    "Lifetime Offer",
    "A one-time premium unlock for the first 100 Journal.IO members.",
    "Reserve lifetime premium access while the launch offer is still available.",
    "Lifetime access",
    "One-time",
    "No renewal",
    "What lifetime unlocks",
    "Be one of the first users to be part of this family.",
    "One-time purchase. Premium stays on this account after sync.",
    "A calmer premium path",
    "Keep AI insights, prompt support, and deeper review tools available whenever you come back to journal.",
    "No weekly or yearly plan switching required.",
    "Built for a longer journaling rhythm",
    "Lifetime access fits the users who want Journal.IO to stay in the background for months, not just one billing cycle.",
    "One purchase. Ongoing access.",
    "Lifetime-offer positioning",
    "This screen is intentionally more expressive than the standard paywall so the lifetime offer feels distinct and worth stopping for.",
    "Still calm, just more premium.",
    "LIFETIME",
    "$149.99",
    "One-time unlock",
    "One time offer",
    ...
    "This lifetime offer is not ready yet. Please try again in a moment.",
    "This payment is pending. Your access will update as soon as the store confirms it.",
    "Premium tools that stay close to your journaling rhythm.",
    ...
    "Close lifetime offer preview",
    "Loading live price",
    "Price available once the offer loads",
    "Lifetime",
    "Open lifetime preview card ${index + 1}",
