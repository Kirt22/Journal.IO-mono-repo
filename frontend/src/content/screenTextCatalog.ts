...
export const screenTextCatalog = {
  ...
  "insights/EntryMindMapScreen.tsx": [
    ...
    "Share selected Mind Map region",
    "Evidence",
    "What stood out",
    "“",
    "”",
  ...
  "onboarding/OnboardingMindMapScreen.tsx": [
    ...
    "/ 100",
    "Continue to Home",
    "Continue to share your Mind Map",
    "Continue",
  ],
  "onboarding/OnboardingMindMapShareScreen.tsx": [
    ...
    "Try preparing share card again",
    "Share now",
    "Try again",
    "Maybe later",
    "center",
  ...
  "profile/BiometricLockScreen.tsx": [
    ...
    "Preview lock screen",
    "Dev only, for App Store screenshots. Tap “Keep locked” to dismiss.",
  ],
