...
export const screenTextCatalog = {
  "HomeScreen.tsx": [
    ...
    "Small Win",
    "What felt slightly easier today, and what may have helped?",
    "Support",
    "Where did you feel supported today, or where did you wish for more support?",
    "Amazing",
    "🤩",
    "Good",
    "😊",
  ...
  "profile/PrivacyScreen.tsx": [
    ...
    "Delete My Account",
    "Help & Support",
    "Need help with account access, subscriptions, reminders, AI insights, privacy questions, or general feedback? Open the public Journal.IO support page to submit a support ticket.",
    "Support",
